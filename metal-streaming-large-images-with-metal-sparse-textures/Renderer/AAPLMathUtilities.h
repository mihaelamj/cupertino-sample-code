...
Abstract:
The header declaring the math utility functions.
*/
...
/// Generates a random three-component vector with values between min and max.
...
/// Returns a vector that is linearly interpolated between the two given three-component vectors.
vector_float3 AAPL_SIMD_OVERLOAD vector_lerp(vector_float3 v0, vector_float3 v1, float t);

/// Returns a vector that is linearly interpolated between the two given four-component vectors.
