...
![Layout diagram that shows an array of textures, an array of buffers, and an array of constants all encoded into a single argument buffer.](Documentation/argument-buffers-with-heaps-1-ArgumentBufferWithArrays.png)
