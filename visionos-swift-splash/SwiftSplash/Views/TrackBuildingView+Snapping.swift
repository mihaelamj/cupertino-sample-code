...
extension TrackBuildingView {
    ...
    func handleSnap(_ snapInfo: DragSnapInfo,
        ...
        if timeSinceLastMove <= AppState.snapEpsilon {
            return
        }
        ...
        guard distance < AppState.maximumSnapDistance,
        ...
        Task(priority: .userInitiated) {
            ...
            while now <= lastMoved + AppState.secondsAfterDragToContinueSnap {
                now = Date.timeIntervalSinceReferenceDate
                let totalElapsedTime = now - startTime
                
                let alpha = totalElapsedTime / AppState.secondsAfterDragToContinueSnap
