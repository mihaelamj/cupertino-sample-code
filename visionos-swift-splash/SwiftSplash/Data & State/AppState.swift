...
public class AppState {
    ...
    static var rideStartTime: TimeInterval = 0
    
    static var rideDuration: TimeInterval = 0.0
    ...
    /// Indicate how close two compatible connection points have to be
    /// in order to snap.
    static let maximumSnapDistance = Float(0.14)
    ...
    static var secondsAfterDragToContinueSnap = TimeInterval(0.025)
    ...
    static var rotateSnapTime: TimeInterval = 10
    ...
    static var rotatingParentNodeName = "Rotating Parent"
    ...
    static var isRotating = false
    
    static var isSnapping = false
    ...
    public var pieces = [
        Piece(name: String(localized: "Straight"), key: .slide1, sceneName: "Slide01.usda"),
        Piece(name: String(localized: "Slide"), key: .slide2, sceneName: "Slide02.usda"),
        Piece(name: String(localized: "Right Turn"), key: .slide3, sceneName: "Slide03.usda"),
        Piece(name: String(localized: "Left Turn"), key: .slide4, sceneName: "Slide04.usda"),
        Piece(name: String(localized: "Spiral"), key: .slide5, sceneName: "Slide05.usda")
    ]
    init() {
        root.name = "Root"
