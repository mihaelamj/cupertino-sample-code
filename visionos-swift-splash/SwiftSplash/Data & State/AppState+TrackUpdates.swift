    ...
    func startWaterFilling() {
        Task {
            ...
            while currentPiece != nil {
                ...
                let adjustedPieceStartTime = (AppState.shouldPauseRide)
                    ? pieceStartTime + Date.timeIntervalSinceReferenceDate - AppState.pauseStartTime
                    : pieceStartTime
