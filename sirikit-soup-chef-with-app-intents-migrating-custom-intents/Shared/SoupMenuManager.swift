...
Abstract:
A `DataManager` subclass that persists active menu items.
*/
...
extension SoupMenuManager {
    ...
    public func findItem(by identifier: String) -> MenuItem? {
        return dataAccessQueue.sync {
            return managedData.first { $0.id == MenuItem.Identifier(rawValue: identifier) }
        }
    }
