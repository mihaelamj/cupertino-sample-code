...
public class DataManager<ManagedDataType: Codable> {
    ...
    /// The data managed by this `DataManager`. Only access this via the `dataAccessQueue`.
    ...
    /// Subclasses implement this method and set their own initial data for `managedData`.
