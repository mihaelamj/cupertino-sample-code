...
extension SoupMenuManager {
    ...
    /// Each time an order is placed, instantiate an `INInteraction` object and donate it to the system (see `SoupOrderDataManager` extension).
    ...
    /// isn't available on the regular menu to demonstrate how relevant shortcuts are able to
