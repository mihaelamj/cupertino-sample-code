...
Abstract:
A class that displays a list of previously placed orders.
*/
...
class OrderHistoryViewController: UIViewController {
    ...
    override func restoreUserActivityState(_ activity: NSUserActivity) {
        ...
        if activity.activityType == NSUserActivity.viewMenuActivityType {
            ...
            // This order came from the "View Menu" shortcut, based on `NSUserActivity`.
            ...
            // This order started as a shortcut, but isn't complete because the user tapped the Soup Chef Intent UI
            ...
            // This order was created outside of the main app through an intent.
