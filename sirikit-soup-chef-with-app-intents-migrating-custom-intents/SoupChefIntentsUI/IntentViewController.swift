...
Abstract:
Create a custom user interface that shows in the Siri interface, as well by touching and holding on a shortcut on the Lock screen or in Spotlight.
*/
import IntentsUI
import SoupKit
...
class IntentViewController: UIViewController, INUIHostedViewControlling {
    ...
    func configureView(for parameters: Set<INParameter>,
        ...
        /*
         The app can display different UIs depending on whether the intent is in the confirmation or handle phase.
    ...
    private func attachChild(_ viewController: UIViewController) {
        ...
        if let subview = viewController.view {
            ...
            // Set the child controller's view to the exact same size as the parent controller's view.
