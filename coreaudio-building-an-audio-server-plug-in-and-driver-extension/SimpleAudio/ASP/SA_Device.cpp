		...
		case kAudioStreamPropertyPhysicalFormat:
			{
				...
				ThrowIf(theNewFormat->mFormatFlags != (kAudioFormatFlagIsSignedInteger | kAudioFormatFlagsNativeEndian | kAudioFormatFlagIsPacked), CAException(kAudioDeviceUnsupportedFormatError), "SA_Device::Stream_SetPropertyData: unsupported format flags for kAudioStreamPropertyPhysicalFormat");
				ThrowIf(theNewFormat->mBytesPerPacket != 4, CAException(kAudioDeviceUnsupportedFormatError), "SA_Device::Stream_SetPropertyData: unsupported bytes per packet for kAudioStreamPropertyPhysicalFormat");
				...
				ThrowIf(theNewFormat->mBytesPerFrame != 4, CAException(kAudioDeviceUnsupportedFormatError), "SA_Device::Stream_SetPropertyData: unsupported bytes per frame for kAudioStreamPropertyPhysicalFormat");
				...
				ThrowIf(theNewFormat->mBitsPerChannel != 16, CAException(kAudioDeviceUnsupportedFormatError), "SA_Device::Stream_SetPropertyData: unsupported bits per channel for kAudioStreamPropertyPhysicalFormat");
...
CFStringRef	SA_Device::HW_CopyDeviceUID(io_object_t inIOObject)
{
	...
	SA_IOKitObject::CopyProperty_CFString(inIOObject, CFSTR(kSimpleAudioDriver_RegistryKey_DeviceUID), true, theAnswer);
	return theAnswer;
}
...
{
	mIOKitObject.CopyProperty_UInt64(CFSTR(kSimpleAudioDriver_RegistryKey_SampleRate), true, const_cast<SA_Device*>(this)->mSampleRateShadow);
...
{
	mIOKitObject.CopyProperty_UInt32(CFSTR(kSimpleAudioDriver_RegistryKey_RingBufferFrameSize), true, const_cast<SA_Device*>(this)->mRingBufferFrameSize);
