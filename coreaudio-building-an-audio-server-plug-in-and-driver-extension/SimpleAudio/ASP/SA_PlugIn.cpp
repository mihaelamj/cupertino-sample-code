...
{
	DebugMsg("SA_PlugIn::IOServiceMatchingHandler");
	...
	while(theService.IsValid())
	{
		...
		try
		{
			...
			DebugMsg("SA_PlugIn::IOServiceMatchingHandler: making new device with id %u", static_cast<unsigned int>(theNewDeviceObjectID));
...
#if LOG_API_CALLS
	DebugMsg("SA_PerformDeviceConfigurationChange: object id: %u", static_cast<unsigned int>(inDeviceObjectID));
#endif
...
#if LOG_API_CALLS
	DebugMsg("SA_AbortDeviceConfigurationChange: object id: %u", static_cast<unsigned int>(inDeviceObjectID));
#endif
...
static Boolean	SA_HasProperty(AudioServerPlugInDriverRef inDriver, AudioObjectID inObjectID, pid_t inClientProcessID, const AudioObjectPropertyAddress* inAddress)
{
	...
	DebugMsg("SA_HasProperty: object id: %u address: (%s, %s, %u)", static_cast<unsigned int>(inObjectID), theSelectorString, theScopeString, static_cast<unsigned int>(inAddress->mElement));
#endif
...
static OSStatus	SA_IsPropertySettable(AudioServerPlugInDriverRef inDriver, AudioObjectID inObjectID, pid_t inClientProcessID, const AudioObjectPropertyAddress* inAddress, Boolean* outIsSettable)
{
	...
	const char theSelectorString[] = CA4CCToCString(inAddress->mSelector);
	const char theScopeString[] = CA4CCToCString(inAddress->mScope);
	DebugMsg("SA_IsPropertySettable: object id: %u address: (%s, %s, %u)", static_cast<unsigned int>(inObjectID), theSelectorString, theScopeString, static_cast<unsigned int>(inAddress->mElement));
#endif
...
static OSStatus	SA_GetPropertyDataSize(AudioServerPlugInDriverRef inDriver, AudioObjectID inObjectID, pid_t inClientProcessID, const AudioObjectPropertyAddress* inAddress, UInt32 inQualifierDataSize, const void* inQualifierData, UInt32* outDataSize)
{
	...
	const char theSelectorString[] = CA4CCToCString(inAddress->mSelector);
	const char theScopeString[] = CA4CCToCString(inAddress->mScope);
	DebugMsg("SA_GetPropertyDataSize: object id: %u address: (%s, %s, %u)", static_cast<unsigned int>(inObjectID), theSelectorString, theScopeString, static_cast<unsigned int>(inAddress->mElement));
#endif
...
static OSStatus	SA_GetPropertyData(AudioServerPlugInDriverRef inDriver, AudioObjectID inObjectID, pid_t inClientProcessID, const AudioObjectPropertyAddress* inAddress, UInt32 inQualifierDataSize, const void* inQualifierData, UInt32 inDataSize, UInt32* outDataSize, void* outData)
{
	...
	const char theSelectorString[] = CA4CCToCString(inAddress->mSelector);
	const char theScopeString[] = CA4CCToCString(inAddress->mScope);
	DebugMsg("SA_GetPropertyData: object id: %u address: (%s, %s, %u)", static_cast<unsigned int>(inObjectID), theSelectorString, theScopeString, static_cast<unsigned int>(inAddress->mElement));
#endif
...
static OSStatus	SA_SetPropertyData(AudioServerPlugInDriverRef inDriver, AudioObjectID inObjectID, pid_t inClientProcessID, const AudioObjectPropertyAddress* inAddress, UInt32 inQualifierDataSize, const void* inQualifierData, UInt32 inDataSize, const void* inData)
{
	...
	const char theSelectorString[] = CA4CCToCString(inAddress->mSelector);
	const char theScopeString[] = CA4CCToCString(inAddress->mScope);
	DebugMsg("SA_SetPropertyData: object id: %u address: (%s, %s, %u)", static_cast<unsigned int>(inObjectID), theSelectorString, theScopeString, static_cast<unsigned int>(inAddress->mElement));
#endif
