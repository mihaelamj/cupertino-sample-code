...
![Layout diagram that shows an array of textures encoded into an argument buffer as an array of references to those textures.](Documentation/argument-buffers-gpu-encoding-1-ArgumentBuffer.png)
...
![Layout diagram that shows an array of structures as an argument buffer.](Documentation/argument-buffers-gpu-encoding-2-ArgumentBuffer.png)
