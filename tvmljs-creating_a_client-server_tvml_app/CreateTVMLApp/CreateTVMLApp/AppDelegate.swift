...
Abstract:
Delegate that controlls the initial launching of the app.
*/
...
class AppDelegate: UIResponder, UIApplicationDelegate, TVApplicationControllerDelegate {
    ...
    // tvBaseURL points to a server on your local machine. To create a local server for testing purposes, use the
    // following command inside your project folder from the Terminal app: ruby -run -ehttpd . -p9001.
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // The JavaScript URL is used to create the JavaScript context for your TVMLKit application. Although it is
        // possible to separate your JavaScript into separate files, to help reduce the launch time of your
        // application we recommend creating minified and compressed version of this resource.
