...
class RealityView: ARView {
    ...
    private func loadScene() {
        ...
        guard let url = Bundle.main.url(forResource: "Experience", withExtension: "usda"),
        let root = try? AnchorEntity.load(contentsOf: url) else {
            fatalError("Unable to find URL for Experience.usda.")
        }
        boxAnchor.addChild(root)
