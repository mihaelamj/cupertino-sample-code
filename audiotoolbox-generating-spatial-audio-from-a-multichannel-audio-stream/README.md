...
The sample sets the spatialization algorithm to ``kSpatializationAlgorithm_UseOutputType`` for the highest-quality spatial rendering across different hardware.
