...
Abstract:
The `SampleBufferSource` class reads from audio files, and produces audio sample buffers.
*/
...
class SampleBufferSource {
    ...
    // The file that provides audio samples.
    ...
    // Creates a new sample buffer source.
