...
- (instancetype)initWithFrame:(NSRect)frameRect
{
    ...
    if (self != nil)
    {
        ...
        // Instead of guessing the font and size, give it size 0 and macOS gives you the proper font metrics for the NSTouchBar.
        self.textField.font = [NSFont systemFontOfSize: 0];
...
// IconTextItemView is for measuring the image and text width.
...
- (__kindof NSScrubberItemView *)scrubber:(NSScrubber *)scrubber viewForItemAtIndex:(NSInteger)index
{
    ...
    itemView.imageView.image = [NSImage imageNamed:NSImageNameBookmarksTemplate];
