...
Abstract:
Shaders implementing antialiasing and tone mapping effects.
*/
...
constant bool gUseTemporalAntialiasing [[function_constant(AAPLFunctionConstIndexTemporalAntialiasing)]];
...
fragment xhalf4 fragmentResolveShader(AAPLSimpleTexVertexOut in                     [[stage_in]],
