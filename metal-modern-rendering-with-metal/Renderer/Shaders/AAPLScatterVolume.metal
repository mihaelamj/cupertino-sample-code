...
Abstract:
Shaders for rendering a scatter volume.
*/
...
#if LOCAL_LIGHT_SCATTERING
                             device AAPLPointLightData * pointLightBuffer   [[ buffer(AAPLBufferIndexPointLights) ]],
                             device AAPLSpotLightData * spotLightBuffer     [[ buffer(AAPLBufferIndexSpotLights) ]],
