...
Abstract:
Common lighting functions used by shaders.
*/
...
static xhalf3 evaluateBRDF(AAPLPixelSurfaceData surface,
                           xhalf3 viewDir,
...
static xhalf3 IBL(AAPLPixelSurfaceData surface,
...
static xhalf3 applyPointLight(AAPLPixelSurfaceData surface,
...
// Calculates the lighting contribution from a point light.
static xhalf3 applySpotLight(AAPLPixelSurfaceData surface,
                             AAPLSpotLightData light,
                             float localLightIntensity,
                             float3 position,
                             xhalf3 viewDir
...
static xhalf3 lightingShader(AAPLPixelSurfaceData surfaceData,
                             xhalf aoSample,
                             float depth,
                             ...
                             )
{
    ...
    xhalf3 viewDir = (xhalf3)normalize(cameraParams.invViewMatrix[3].xyz - worldPosition.xyz);
