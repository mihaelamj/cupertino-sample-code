...
constant bool gUseSinglePassDeferred   [[function_constant(AAPLFunctionConstIndexSinglePassDeferred)]];
...
fragment xhalf4 tiledLightingShader(AAPLSimpleTexVertexOut in                      [[ stage_in ]],
                                    ...
                                    xhalf4 albedoTarget      [[color(AAPLGBufferAlbedoAlphaIndex), function_constant(gUseSinglePassDeferred)]],
                                    xhalf4 normalTarget      [[color(AAPLGBufferNormalsIndex), function_constant(gUseSinglePassDeferred)]],
                                    xhalf4 emissiveTarget    [[color(AAPLGBufferEmissiveIndex), function_constant(gUseSinglePassDeferred)]],
                                    xhalf4 F0RoughnessTarget [[color(AAPLGBufferF0RoughnessIndex), function_constant(gUseSinglePassDeferred)]],
