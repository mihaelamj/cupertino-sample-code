        ...
        didSet {
            ...
            if let parent = accessibilityParent() as? CustomLayoutAreaView {
                if !(oldValue.origin == bounds.origin) && parent.selectedLayoutItem == self {
                    ...
                    NSAccessibility.post(element: accessibilityParent, notification: NSAccessibility.Notification.selectedChildrenMoved)
                }
            }
        }
    }
...
extension LayoutItem {
    ...
    override func accessibilityFrame() -> NSRect {
        ...
        if let accessibilityParent = accessibilityParent() as? CustomLayoutAreaView {
            result = NSAccessibility.screenRect(fromView: accessibilityParent, rect: bounds)
        }
        return result
    }
