...
class CustomButtonView: NSView {
    ...
    override func draw(_ dirtyRect: NSRect) {
        let upImage = NSImage(named: ButtonImages.buttonUp)
        let downImage = NSImage(named: ButtonImages.buttonDown)
        let highlightImage = NSImage(named: ButtonImages.buttonHighlight)
