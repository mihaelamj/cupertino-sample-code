...
class CustomSliderView: NSView, NSAccessibilitySlider {
    ...
    override func keyDown(with event: NSEvent) {
        ...
        switch char {
        case Character(NSEvent.SpecialKey.downArrow.rawValue)!, Character(NSEvent.SpecialKey.leftArrow.rawValue)!:
            decrement()
        case Character(NSEvent.SpecialKey.upArrow.rawValue)!, Character(NSEvent.SpecialKey.rightArrow.rawValue)!:
            increment()
        default: break
        }
    }
