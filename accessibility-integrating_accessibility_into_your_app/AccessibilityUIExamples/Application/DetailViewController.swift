...
class DetailViewController: NSViewController {
    ...
    var detailItemRecord: Example! {
        didSet {
            ...
            if !children.isEmpty {
                let viewcController = children[0]
                viewcController.view.isHidden = true
                viewcController.removeFromParent()
            }
            ...
            guard !detailItemRecord.viewControllerIdentifier.isEmpty else { return }
            
            // Load the example storyboard and embed.
            let storyboard: NSStoryboard =
                NSStoryboard(name: detailItemRecord.viewControllerIdentifier, bundle: nil)

            let sceneIdentifier = detailItemRecord.viewControllerIdentifier
