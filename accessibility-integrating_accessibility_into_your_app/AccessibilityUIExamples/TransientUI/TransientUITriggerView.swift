...
extension TransientUITriggerView {
    ...
    fileprivate func sendTransientUIChangedNotification() {
        let changedElements = NSAccessibility.unignoredChildren(from: transientView.subviews)
        NSAccessibility.post(
            element: self,
            notification: .layoutChanged,
            userInfo: [NSAccessibility.NotificationUserInfoKey.uiElements: changedElements])
    }
