...
class CustomRadioButtonsView: NSView, NSAccessibilityGroup {
    ...
    fileprivate func commonInit() {
        radioButtonText = [
            ...
            for button in 0..<count {
                ...
                bounds = NSAccessibility.screenRect(fromView: self, rect: bounds)
                ...
                radioButton.setAccessibilityRole(NSAccessibility.Role.radioButton)
    ...
    func rectForButton(button: Int) -> NSRect {
        return NSRect(x: bounds.origin.x + 4,
    ...
    override func draw(_ dirtyRect: NSRect) {
        ...
        for idx in 0..<radioButtonCount {
            ...
            radioCircleImage = NSImage(named: imageName)!
...
extension CustomRadioButtonsView {
    ...
    override func accessibilityChildren() -> [Any]? {
        ...
        for button in 0..<count {
            ...
            radioButton.setAccessibilityActivationPoint(NSAccessibility.screenPoint(fromView: self, point: activationBoundsCenterPoint))
