...
Abstract:
The delegate containing server information.
*/
...
class AppDelegate: UIResponder, UIApplicationDelegate, TVApplicationControllerDelegate {
    ...
    // purposes, use the following command inside your project folder from the Terminal app: ruby -run -ehttpd . -p9001.
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Although it is possible to separate your JavaScript into separate files, to help reduce the launch time
        // of your application we recommend creating minified and compressed version of this resource.
