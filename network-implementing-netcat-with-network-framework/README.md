...
[dispatch_data_t]: https://developer.apple.com/documentation/dispatch/dispatch_data_t
[dispatch_queue_t]: https://developer.apple.com/documentation/dispatch/dispatch_queue_t

[nw_connection_t]: https://developer.apple.com/documentation/network/nw_connection_t
[nw_content_context_t]: https://developer.apple.com/documentation/network/nw_content_context_t
[nw_endpoint_t]: https://developer.apple.com/documentation/network/nw_endpoint_type_t
[nw_listener_t]: https://developer.apple.com/documentation/network/nw_listener_t
[nw_parameters_t]: https://developer.apple.com/documentation/network/nw_parameters_t

[nw_connection_cancel]: https://developer.apple.com/documentation/network/nw_connection_cancel(_:)
[nw_connection_create]: https://developer.apple.com/documentation/network/nw_connection_create(_:_:)
[nw_connection_receive]: https://developer.apple.com/documentation/network/nw_connection_receive(_:_:_:_:)
[nw_connection_send]: https://developer.apple.com/documentation/network/nw_connection_send(_:_:_:_:_:)

[nw_connection_set_queue]: https://developer.apple.com/documentation/network/nw_connection_set_queue(_:_:)
[nw_connection_start]: https://developer.apple.com/documentation/network/nw_connection_start(_:)

[nw_endpoint_create_host]: https://developer.apple.com/documentation/network/nw_endpoint_create_host(_:_:)

[nw_listener_create_with_port]: https://developer.apple.com/documentation/network/nw_listener_create_with_port(_:_:)
[nw_listener_create]: https://developer.apple.com/documentation/network/nw_listener_create(_:)

[nw_parameters_create_secure_tcp]: https://developer.apple.com/documentation/network/nw_parameters_create_secure_tcp(_:_:)
[nw_parameters_create_secure_udp]: https://developer.apple.com/documentation/network/nw_parameters_create_secure_udp(_:_:)
[nw_parameters_set_local_endpoint]: https://developer.apple.com/documentation/network/nw_parameters_set_local_endpoint(_:_:)

[nw_retain]: https://developer.apple.com/documentation/network/2976820-nw_retain

[nw_connection_state_cancelled]: https://developer.apple.com/documentation/network/nw_connection_state_cancelled
