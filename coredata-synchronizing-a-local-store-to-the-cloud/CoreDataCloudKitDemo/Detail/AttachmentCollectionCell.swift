...
Abstract:
A table view cell subclass that implements the collection view delegate and collection view data source to present the current post’s attachments.
*/
...
class AttachmentCollectionCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        // A newly added attachment by this peer doesn’t have imageData, but getThumbnail() immediately returns with the .thumbnail.
