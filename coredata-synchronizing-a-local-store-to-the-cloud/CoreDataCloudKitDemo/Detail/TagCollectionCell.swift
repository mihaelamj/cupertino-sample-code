...
Abstract:
A table view cell subclass that implements a collection view delegate and collection view data source to present the tags of the current post.
*/
...
class TagCollectionCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    /**
     ...
     Dequeueing a cell triggers collectionView data loading, but there is no data, so the load ends quickly.
     
     The view controller calls collectionView.reloadData when the data is ready.
     */
