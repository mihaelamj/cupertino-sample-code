...
class DetailViewController: SpinnerViewController, UICloudSharingControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Refresh the user interface in the next run loop to reload the collection views after the view loading process.
    ...
    override func setEditing(_ editing: Bool, animated: Bool) {
        ...
        // Update the user interface based on the editing state.
        titleTextField.isEnabled = editing
        contentTextView.isEditable = editing
        
        // If the user interface is entering the editing state, simply return.
        guard !editing, let post = post else { return }
        
        // If exiting the editing state, save the changes and update the user interface.
        // In this case, post should not be nil.
...
extension DetailViewController {
    ...
    /**
     Hide the keyboard, if there is one, and pick up the title and content fields.
     */
