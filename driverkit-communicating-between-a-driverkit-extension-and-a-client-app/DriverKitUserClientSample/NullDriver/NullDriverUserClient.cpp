...
Abstract:
A DriverKit null driver user client implementation that only logs interactions with its client.
*/
...
#define Log(fmt, ...) os_log(OS_LOG_DEFAULT, "NullDriver UserClient - " fmt "\n", ##__VA_ARGS__)
...
const IOUserClientMethodDispatch externalMethodChecks[NumberOfExternalMethods] = {
	...
	{
		.function = (IOUserClientMethodFunction) &NullDriverUserClient::StaticHandleExternalCheckedStruct,
	...
	{
		.function = (IOUserClientMethodFunction) &NullDriverUserClient::StaticRegisterAsyncCallback,
	...
	{
		.function = (IOUserClientMethodFunction) &NullDriverUserClient::StaticHandleAsyncRequest,
...
/// - Tag: Struct_NullDriverUserClient_IVars
...
bool NullDriverUserClient::init(void)
{
	bool result = false;
	...
	ivars = IONewZero(NullDriverUserClient_IVars, 1);
	if (ivars == nullptr)
	{
...
kern_return_t NullDriverUserClient::Start_Impl(IOService* provider)
{
...
kern_return_t NullDriverUserClient::Stop_Impl(IOService* provider)
{
	kern_return_t ret = kIOReturnSuccess;
...
void NullDriverUserClient::free(void)
{
	Log("free()");
	...
	IOSafeDeleteNULL(ivars, NullDriverUserClient_IVars, 1);
...
kern_return_t NullDriverUserClient::ExternalMethod(uint64_t selector, IOUserClientMethodArguments* arguments, const IOUserClientMethodDispatch* dispatch, OSObject* target, void* reference)
{
	kern_return_t ret = kIOReturnSuccess;
...
kern_return_t NullDriverUserClient::HandleExternalScalar(IOUserClientMethodArguments* arguments)
{
	kern_return_t ret = kIOReturnSuccess;
...
kern_return_t NullDriverUserClient::HandleExternalStruct(IOUserClientMethodArguments* arguments)
{
	kern_return_t ret = kIOReturnSuccess;
...
kern_return_t NullDriverUserClient::StaticHandleExternalCheckedScalar(OSObject* target, void* reference, IOUserClientMethodArguments* arguments)
{
	if (target == nullptr)
	{
	...
	return ((NullDriverUserClient*)target)->HandleExternalCheckedScalar(reference, arguments);
}

kern_return_t NullDriverUserClient::StaticHandleExternalCheckedStruct(OSObject* target, void* reference, IOUserClientMethodArguments* arguments)
{
	if (target == nullptr)
	{
		return kIOReturnError;
	...
	return ((NullDriverUserClient*)target)->HandleExternalCheckedStruct(reference, arguments);
}

kern_return_t NullDriverUserClient::StaticRegisterAsyncCallback(OSObject* target, void* reference, IOUserClientMethodArguments* arguments)
{
	if (target == nullptr)
	{
		return kIOReturnError;
	...
	return ((NullDriverUserClient*)target)->RegisterAsyncCallback(reference, arguments);
}

kern_return_t NullDriverUserClient::StaticHandleAsyncRequest(OSObject* target, void* reference, IOUserClientMethodArguments* arguments)
{
	if (target == nullptr)
	{
		return kIOReturnError;
	...
	return ((NullDriverUserClient*)target)->HandleAsyncRequest(reference, arguments);
}

// MARK: Safer External Handlers
kern_return_t NullDriverUserClient::HandleExternalCheckedScalar(void* reference, IOUserClientMethodArguments* arguments)
{
...
kern_return_t NullDriverUserClient::HandleExternalCheckedStruct(void* reference, IOUserClientMethodArguments* arguments)
{
	// This function was checked by IOUserClientMethodDispatch, so it doesn't need to validate the arguments.
...
kern_return_t NullDriverUserClient::RegisterAsyncCallback(void* reference, IOUserClientMethodArguments* arguments)
{
...
kern_return_t NullDriverUserClient::HandleAsyncRequest(void* reference, IOUserClientMethodArguments* arguments)
{
...
void NullDriverUserClient::SimulatedAsyncEvent_Impl(OSAction* action, uint64_t time)
{
...
// MARK: Detail Helpers
void NullDriverUserClient::PrintExtendedErrorInfo(kern_return_t ret)
{
