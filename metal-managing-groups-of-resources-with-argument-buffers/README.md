...
![A layout diagram entitled "Encoded Comments" that depicts textures, samplers, buffers, and constants as individual arguments for different draw calls.](Documentation/argument-buffers-1-IndividualArguments.png)
...
![A layout diagram entitled "Encoded commands" that depicts encoded textures, samplers, buffers, and constants encoded as grouped arguments within an argument buffer, which is set as an individual argument for different draw calls.](Documentation/argument-buffers-2-ArgumentBuffers.png)
