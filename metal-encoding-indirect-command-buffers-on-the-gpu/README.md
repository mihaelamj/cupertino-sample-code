...
![Flow chart of an algorithm being parallelized on the GPU with the CPU waiting on its results.](Documentation/icbs-with-gpu-encoding-2-CpuRoundTrip.png)
