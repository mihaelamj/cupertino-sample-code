...
// When enabled, writes depth values in eye space to the geometry buffer (geometry buffer) depth
...
// depth is written to the geometry buffer depth component and an extra inverse
