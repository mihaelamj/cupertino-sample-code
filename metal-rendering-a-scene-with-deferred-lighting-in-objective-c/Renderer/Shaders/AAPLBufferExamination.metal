...
light_volume_visualization_vertex(const device float4           *vertices        [[ buffer(AAPLBufferIndexMeshPositions) ]],
...
texture_values_vertex(const device AAPLSimpleVertex *vertices [[ buffer(AAPLBufferIndexMeshPositions) ]],
                      uint                          vid       [[ vertex_id ]])
{
