...
// Material textures (indexed by AAPLTextureIndices) to set in the Metal Render Command Encoder
...
// An array of AAPLSubmesh objects containing buffers and data with which the render can draw
