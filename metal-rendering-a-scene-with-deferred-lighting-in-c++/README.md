...
![Screenshot of the sample app running to show the rich lighting effects.](Documentation/deferred-lighting-cpp-1-DeferredLighting.png)
...
![Diagram showing the outputs of the two render passes in a traditional deferred lighting algorithm.](Documentation/deferred-lighting-cpp-2-TraditionalDeferredLighting.png)
...
![Diagram showing how geometry buffer data in a traditional deferred lighting algorithm is transferred between the GPU and system memory.](Documentation/deferred-lighting-cpp-3-TraditionalDeferredLightingOnTBDR.png)
...
![Diagram showing how geometry buffer data in a single-pass deferred lighting algorithm is accessed in tile memory.](Documentation/deferred-lighting-cpp-4-SinglePassDeferredLightingOnTBDR.png)
...
![Diagram showing two lights executed by a fragment shader, without raster order groups.](Documentation/deferred-lighting-cpp-5-DeferredLightingWithoutRasterOrderGroups.png)
...
![Diagram showing two lights executed by a fragment shader, with raster order groups.](Documentation/deferred-lighting-cpp-6-DeferredLightingWithRasterOrderGroups.png)
...
![Rendering that shows the shadow map.](Documentation/deferred-lighting-cpp-7-ShadowMap.png)
...
![Rendering that shows the geometry buffer textures.](Documentation/deferred-lighting-cpp-8-GBufferTextures.png)
...
![Rendering that shows point light fragment coverage when the stencil mask is enabled.](Documentation/deferred-lighting-cpp-9-StencilMaskOnly.png)
...
![Rendering that shows point light fragment coverage when the stencil mask is disabled.](Documentation/deferred-lighting-cpp-10-StencilMaskVSFullVolumes.png)
