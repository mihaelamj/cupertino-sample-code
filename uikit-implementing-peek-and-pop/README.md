...
When the system detects enough pressure in the 3D Touch to pop the view controller, it calls [`previewingContext(_:commit:)`](https://developer.apple.com/documentation/uikit/uiviewcontrollerpreviewingdelegate/previewingContext(_:commit:)). Take the passed in view controller and present to the user.  
