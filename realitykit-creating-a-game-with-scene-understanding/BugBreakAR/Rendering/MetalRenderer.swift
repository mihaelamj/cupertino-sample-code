...
class MetalRenderer {
    ...
    private let alignedSharedUniformsSize: Int = (MemoryLayout<SharedUniforms>.size & ~0xFF) + 0x100
    ...
    func draw(_ camera: CustomCameraComponent) {
    ...
    private func updateSharedUniforms(camera: CustomCameraComponent) {
