...
extension DomainService.EntryMetadata: @retroactive Value {
...
extension DomainService.EntryType: @retroactive Value {
...
extension DomainService.ItemIdentifier: @retroactive Value {
...
extension DomainService.ContentSha256S: @retroactive Value {
...
extension DomainService.ContentStorageType: @retroactive Value {
...
extension DomainService.SimulatedError.AccessType: @retroactive Value {
    ...
    private static func computeSizeInline(conn: Connection,
        ...
        if let contentRow = try? conn.pluck(contentsTable.filter(idKey == id && conflictKey == false)) {
            ...
            if type == .symlink &&
                ...
                // the system can materialize symlinks as it enumerates them.
                do {
