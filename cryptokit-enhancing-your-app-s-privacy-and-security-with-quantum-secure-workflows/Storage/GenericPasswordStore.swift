...
struct GenericPasswordStore {
    ...
    func storeKey<T: GenericPasswordConvertible>(_ key: T, account: String) throws {
        ...
        try key.secKeyRepresentation.withUnsafeBytes { keyBytes in
    ...
    func readKey<T: GenericPasswordConvertible>(account: String) throws -> T? {
        ...
        case errSecSuccess:
            ...
            return try T(secKeyRepresentation: data)  // Convert back to a key.
    ...
    func deleteKey(account: String) throws {
        ...
        case errSecItemNotFound, errSecSuccess: break // OK to ignore.
        case let status:
