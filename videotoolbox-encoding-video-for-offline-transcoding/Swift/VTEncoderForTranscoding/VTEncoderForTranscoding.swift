...
public struct Options: Sendable {
    ...
    /// A Boolean value that specifies whether to save power during transcoding.
    public let savePower: Bool
    ...
    ///   - savePower: A Boolean value that specifies whether to save power during transcoding.
...
public func processVideoTranscoding(options: Options) async throws {
    ...
    let compressionTask = Task {
        ...
        let videoSource = VideoSource(filePath: options.sourceMoviePath,
...
private func compressFrames(from videoSource: VideoSource,
                            options: Options,
