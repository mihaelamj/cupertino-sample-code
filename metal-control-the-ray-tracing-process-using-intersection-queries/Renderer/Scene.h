...
// Represents a piece of geometry in a scene, The sample composes Geometry objects from primitives
// such as triangles or spheres.  Each Geometry object has its own primitive acceleration structure
// and, optionally, an intersection function.  The sample creates copies, or "instances" of
