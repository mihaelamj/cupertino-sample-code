...
class DriverLoadingViewModel: NSObject {
    ...
    private let dextIdentifier: String = "com.example.apple-samplecode.NetworkingDriverKitSample"

    public var dextLoadingState: String {
        switch state {
        case .unloaded:
            return "NetworkingDriverKitSample isn't loaded."
        case .activating:
            return "Activating NetworkingDriverKitSample, please wait."
        case .needsApproval:
            return "Please follow the prompt to approve NetworkingDriverKitSample."
        case .activated:
            return "NetworkingDriverKitSample has been activated and is ready to use."
        case .activationError:
            return "NetworkingDriverKitSample has experienced an error during activation.\nPlease check the logs to find the error."
        }
    }
}
