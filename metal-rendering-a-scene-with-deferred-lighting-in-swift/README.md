...
![Screenshot of the sample app running to show the rich lighting effects.](Documentation/deferred-lighting-swift-1-DeferredLighting.png)
...
![Diagram showing the outputs of the two render passes in a traditional deferred lighting algorithm.](Documentation/deferred-lighting-swift-2-TraditionalDeferredLighting.png)
...
![Diagram showing how geometry buffer data in a traditional deferred lighting algorithm is transferred between the GPU and system memory.](Documentation/deferred-lighting-swift-3-TraditionalDeferredLightingOnTBDR.png)
...
![Diagram showing how geometry buffer data in a single-pass deferred lighting algorithm is accessed in tile memory.](Documentation/deferred-lighting-swift-4-SinglePassDeferredLightingOnTBDR.png)
...
![Diagram showing two lights executed by a fragment shader, without raster order groups.](Documentation/deferred-lighting-swift-5-DeferredLightingWithoutRasterOrderGroups.png)
...
![Diagram showing two lights executed by a fragment shader, with raster order groups.](Documentation/deferred-lighting-swift-6-DeferredLightingWithRasterOrderGroups.png)
...
![Rendering that shows the shadow map.](Documentation/deferred-lighting-swift-7-ShadowMap.png)
...
![Rendering that shows the geometry buffer textures.](Documentation/deferred-lighting-swift-8-GBufferTextures.png)
...
![Rendering that shows point light fragment coverage when the stencil mask is enabled.](Documentation/deferred-lighting-swift-9-StencilMaskOnly.png)
...
![Rendering that shows point light fragment coverage when the stencil mask is disabled.](Documentation/deferred-lighting-swift-10-StencilMaskVSFullVolumes.png)
