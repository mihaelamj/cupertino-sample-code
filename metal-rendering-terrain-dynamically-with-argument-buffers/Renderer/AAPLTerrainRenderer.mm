...
@implementation AAPLTerrainRenderer
{
    ...
    id <MTLComputePipelineState> _pplCmp_CopyChannel1Only;
}
                       ...
                       library:(id <MTLLibrary>)library
{
    ...
    [commandBuffer addCompletedHandler:^(id <MTLCommandBuffer> nonnull) {
    ...
    //  - this is needed further along in data initialization
    {
        ...
        _pplCmp_CopyChannel1Only         = CreateKernelPipeline(device, library, @"TerrainKnl_CopyChannel1Only");
    }
    ...
    {
        id <MTLTexture> _srcTex = _targetHeightmap;
        ...
        id <MTLTexture> _dstTex = [device newTextureWithDescriptor:texDesc];
        ...
        [computeEncoder setTexture:_srcTex atIndex:0];
        [computeEncoder setTexture:_dstTex atIndex:1];
        [computeEncoder dispatchThreads:MTLSizeMake(heightMapWidth, heightMapHeight, 1) threadsPerThreadgroup:threadsPerThreadgroup];
        [computeEncoder endEncoding];
