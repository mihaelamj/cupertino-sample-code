...
/// ParameterSpec mirrors that gets passed to
...
public struct ParameterSpec: NodeSpec {
    ...
    ///   - identifier: A unique string that is used to access the parameter.
    ///   - name: The localized display name of the parameter.
    ///   - units: The parameter's unit of measurement.
    ///   - valueRange: The parameter's range in the parameter's unit of measurement.
